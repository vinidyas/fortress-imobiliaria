  ...
  const items: NavItem[] = [
    ...
    { key: 'faturas', label: 'Faturas', href: r('faturas.index', undefined, '/faturas'), icon: 'M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01', ability: 'faturas.view' },
    {
      ...
      children: [
        ...
        {
          key: 'financeiro-reconciliation',
          label: 'Conciliação Bancária',
          href: r('financeiro.reconciliation', undefined, '/financeiro/conciliacao'),
          ability: 'financeiro.reconcile',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { key: 'relatorios-extratos', label: 'Extratos Bancários', href: route('relatorios.bank-statements'), ability: 'reports.view.financeiro' },
        ...
        { key: 'relatorios-extrato-detalhado', label: 'Relatório de Despesas', href: route('relatorios.bank-ledger'), ability: 'reports.view.financeiro' },
        { key: 'relatorios-extrato-receitas', label: 'Relatório de Receitas', href: r('relatorios.bank-ledger-receitas', undefined, '/relatorios/extratos/receitas'), ability: 'reports.view.financeiro' },
