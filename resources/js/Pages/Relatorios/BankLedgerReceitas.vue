...
const STORAGE_KEY = 'reports:bank-ledger-receitas:filters';
...
const typeOptions = [{ value: 'receita', label: 'Receitas' }];
...
<template>
<AuthenticatedLayout title="Relatório de Receitas">
  <Head title="Relatório de Receitas" />
    ...
    >
      <header class="flex flex-col gap-1">
        <h1 class="text-xl font-semibold text-white">Relatório de Receitas</h1>
